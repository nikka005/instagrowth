    ...
    <div className="min-h-screen bg-[#030305] flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-white/60 mb-8">Sign in to continue to your dashboard</p>
      ...
      <div className="hidden lg:block flex-1 relative overflow-hidden">
        ...
        <img
          src="https://images.unsplash.com/photo-1684488624316-774ea1824d97?crop=entropy&cs=srgb&fm=jpg&q=85&w=800"
          alt="Dashboard"
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="glass p-8 rounded-3xl max-w-md text-center">
            <h2 className="font-display text-2xl font-bold text-white mb-4">
              Scale Your Instagram Agency
            </h2>
            <p className="text-white/70">
              Join 10,000+ growth agencies using AI to dominate Instagram.
            </p>
          </div>
        </div>
      </div>
